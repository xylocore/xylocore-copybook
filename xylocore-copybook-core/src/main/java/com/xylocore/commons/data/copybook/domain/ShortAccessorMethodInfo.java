...
public class ShortAccessorMethodInfo
    extends
        AccessorMethodInfo
{
    //
     ...
     * FILLIN
     */
    public ShortAccessorMethodInfo()
    {
    ...
    protected void acceptVisit( Visitor aVisitor )
    {
        ...
        aVisitor.visitShortAccessorMethodInfo( this );
    ...
    protected void acceptLeave( Visitor aVisitor )
    {
        ...
        aVisitor.leaveShortAccessorMethodInfo( this );
    }
}
